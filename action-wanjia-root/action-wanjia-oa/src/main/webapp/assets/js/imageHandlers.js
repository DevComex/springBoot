var ss,ssString,ssArr,imgUrlString,imgUrlStringArr,imgUrlArr;
//上传图片页面统一效果处理
...
function saveAlbumFn() {
    ...
    $sBtn.click(function () {
		ss = $(".js_spImgIntro").text().split("jpg");
        ssString=ss.join("jpg ");
        ssArr = ssString.split(" ");
        ssArr.pop();//返回上传图片名称数组
	
    	imgUrlString = $(".js_spImgUrl").text().split("jpg");
        imgUrlStringArr=imgUrlString.join("jpg ");
        imgUrlArr = imgUrlStringArr.split(" ");
        imgUrlArr.pop();//返回上传图片地址数组
        ...
        if (!sdata.Picture.length) {
            ...
            $.ajax({
                ...
                data: {
                	...
                	//pagesName:ssArr,     //图片名称
                	pagesUrl:imgUrlArr,  //图片url
...
function uploadSuccess(file, serverData) {
    try {
        ...
        $(".charapter_review_pic").append('<div class="manhuaPic"><img src="' + serverData.AffixUrl + '"></div>') ;   
        var ImgName = $(".js_spImgIntro").text();//图片名称
        var ImgUrl = $(".js_spImgUrl").text();//图片地址url
     
        ss = ImgName.split("jpg");
        ssString=ss.join("jpg ");
        ssArr = ssString.split(" ");
        ssArr.pop();//返回上传图片名称数组
