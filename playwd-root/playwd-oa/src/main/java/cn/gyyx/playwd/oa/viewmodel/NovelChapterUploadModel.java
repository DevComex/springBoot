...
//    @Pattern(regexp="^(0|[1-9][0-9]*)$",message="invalid-chapterNum|章节参数无效")
    ...
    private Integer novelChapterCode;
    ...
    public Integer getNovelChapterCode() {
        return novelChapterCode;
    }

    public void setNovelChapterCode(Integer novelChapterCode) {
        this.novelChapterCode = novelChapterCode;
    }
