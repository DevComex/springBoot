...
function saveAlbumFn() {
    ...
    $sBtn.click(function () {
        ...
        if (!sdata.Cartoon) {
            ...
            var name = $.trim($("#js_CartoonName").val());   //小说名称
            ...
            var novelChapterCode = getParam().chapterCode? getParam().chapterCode:"";
            ...
            $.ajax({
                ...
                data: {
                	...
                	name:name,   //小说名称
                	cover:eval("("+sdata.Picture[0]+")").PictureUrl,   //封面
                	title:title, //章节名称
                	novelChapterCode:novelChapterCode
