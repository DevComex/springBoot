...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , imagePath: ""                       //自定义接中，路径是以http:开头的，不是站内的目录
...
, toolbars: [["removeformat", "link", "bold", "italic", "underline", "forecolor", "fontborder", "fontsize", "backcolor", "justifycenter", "justifyleft", "justifyright", "insertunorderedlist", "insertorderedlist", "fontfamily", "indent", "paragraph", "emotion", "source", "inserttable", "horizontal", "date", "insertimage"]]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准 "insertimage",
        //        ,labelMap:{
        //            'anchor':'', 'undo':''
        //        }
        //webAppKey
