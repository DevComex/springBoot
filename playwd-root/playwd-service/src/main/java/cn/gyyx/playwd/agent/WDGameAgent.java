...
import cn.gyyx.playwd.beans.common.ServerInfoBean;
...
public class WDGameAgent {
    ...
    private static final Logger logger = GYYXLoggerFactory.getLogger(WDGameAgent.class);
