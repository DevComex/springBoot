...
$.fn.extend({
    ...
    pagesFn: function (setting) {
        var
            ...
            //分页按钮html容器
            pagehtml = '<a ' + (isfirstpg ? 'class="pg_disabled"' : 'class="pg_disabl"') + ' href="javascript:;"  pgid="-4" id="pageStyle">' + btnTxt.prev + '</a>' +
                                  '<a ' + (isfirstpg ? 'class="pg_disabled"' : 'class="pg_disabl"') + ' href="javascript:;" pgid="-3" class="pageStyle">' + btnTxt.first + '</a>';
        ...
        pagehtml += '<a ' + (lastpg ? 'class="pg_disabled"' : 'class="pg_disabl"') + ' href="javascript:;" pgid="-2">' + btnTxt.last + '</a>' +
                                 '<a ' + (lastpg ? 'class="pg_disabled"' : 'class="pg_disabl"') + ' href="javascript:;" pgid="-1">' + btnTxt.next + '</a>';
