...
, toolbars: [["source","undo","redo","unlink","link","cleardoc","|","insertimage","emotion","justifyleft","justifycenter","justifyright","justifyjustify","bold","italic","underline","forecolor","backcolor","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable"]]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准 //,"insertvideo"
//        ,labelMap:{
//            'anchor':'', 'undo':''
//        }
        //webAppKey
