...
$(function () {
    ...
    if (mos == "s") {
        var mohref = "/StaffInfo/DiplomasStatDetails?agencyCode=" + urlcode + "&mo=" + mos;
        ...
        var mohref = "/StaffInfo/DiplomasStatDetails?agencyCode=" + urlcode;
        $(".js_ismo").attr("href", mohref);
        //菜单跳转
        $(".js_li0").click(function () {
    ...
    rankcum("/staffinfo/DiplomasStat?r=", "学历统计柱状图")
});