        ...
        if (!$("#EduInfoID").val()) {
            ...
            for (var i = 0; i < timesdata.length; i++) {
                if (timesdata.eq(i).text() == "0001-01-01") {
                    timesdata.eq(i).addClass("js_hid");
                }
            }
            ...
            var timesdata = $(".btime");
            if ($("#Begindate").val() == "") {
                createEduInfo[id].BeginDate = "0001-01-01"
            } else {
                createEduInfo[id].BeginDate = $("#Begindate").val();
            }
    ...
    $(".js_saveFirstStep").click(function () {
        if ($("#CreateFirstStep").valid()) {
            ...
            function subinfo() {
                ...
                $.ajax({
                    url: 'http://oa.gyyx.cn/PersonalFile/CreateStaffBasicInfo',
                    type: "post",
                    //async: true,
                    ...
                    success: function (d) {
                        alert(d.Message);
                        if (d.Ret == 0) {
                            window.location.href = "http://oa.gyyx.cn/PersonalFile/CreateEmploymentInfo/" + d.Data;
                        }
