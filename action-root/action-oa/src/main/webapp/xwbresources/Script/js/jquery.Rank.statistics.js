...
$(function () {
    ...
    if (mos == "s") {
        var mohref = "/StaffInfo/RankStatDetails?agencyCode=" + urlcode + "&mo=" + mos;
        ...
        var mohref = "/StaffInfo/RankStatDetails?agencyCode=" + urlcode;
        $(".js_ismo").attr("href", mohref);
        //菜单跳转
        $(".js_li0").click(function () {
    ...
    rankpie("/staffinfo/RankStat?r=", "职级统计饼图");
   
    $(".js_down").click(function () {
        rankpie("/staffinfo/DownFullStatisticsSub?r=", "职级统计饼图")
    });
    $(".js_up").click(function () {
        rankcum("/staffinfo/UpFullStatisticsParent?r=", "职级统计柱状图")
    });
    $(".js_zhu").hide();
    //图标切换
    ...
    $(".js_zhulab").click(function () {
        rankcum("/staffinfo/RankStat?r=", "职级统计柱状图");
    });
});