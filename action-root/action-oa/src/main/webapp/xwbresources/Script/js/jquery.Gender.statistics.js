...
$(function () {
    ...
    if (mos == "s") {
        var mohref = "/StaffInfo/GenderStatDetails?agencyCode=" + urlcode + "&mo=" + mos;
        ...
        var mohref = "/StaffInfo/GenderStatDetails?agencyCode=" + urlcode;
        $(".js_ismo").attr("href", mohref);
        //菜单跳转
        $(".js_li0").click(function () {
    ...
    rankpie("/staffinfo/GenderStat?r=", "性别统计饼图");
});