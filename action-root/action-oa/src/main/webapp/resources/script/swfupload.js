...
SWFUpload.prototype.getFlashHTML = function () {
   ...
   if (Sys.ie && ( Sys.ie.substring(0, 1) == "9" || Sys.ie.substring(0, 2) == "10" ) ) {
    ...
    return ['<object id="', this.movieName, '" classid="', classid, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="193" height="30" class="swfupload" style="margin:0 7px;float:left;">',
