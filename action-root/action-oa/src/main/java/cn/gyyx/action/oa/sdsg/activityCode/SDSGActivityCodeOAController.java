package cn.gyyx.action.oa.sdsg.activityCode;
...
import cn.gyyx.action.service.oa.sdsg.activityCode.SDSGOAActivityCodeService;

@Controller
@RequestMapping("/SDSGOAI")
public class SDSGActivityCodeOAController {

	private SDSGOAActivityCodeService sdsgService = new SDSGOAActivityCodeService();
	...
	public ResultBean<String> getActivationProduct(String time){
		...
		result = sdsgService.getActivationProduct(paraDate);
		return result;
	}
	/**
	 * 已激活-市场
	...
	public ResultBean<String> getActivationMarket(String time){
		...
		result = sdsgService.getActivationMarket(paraDate);
		return result;
	}	
	/**
	 * 发放-产品
	...
	public ResultBean<String> getSendMarket(String time){
		...
		result = sdsgService.getSendMarket(paraDate);
		return result;
	}
	@ResponseBody
	...
	public ResultBean<String> insertActivationCode(String num,String channel,String channelStr){
		...
		try {
			result = sdsgService.insertActivationCode(numInt, channelInt, new String(channelStr.getBytes("ISO-8859-1"),"utf-8"));
	...
	public ResultBean<List<ActivityCodeChannelBean>> searchActivityChannel(){
		return sdsgService.searchActivityChannel();
	}
	/**
	 * 查询详细信息
	 * @param model
	...
	public String getActivityCodeMes(Model model,String nowDate){
		...
		ResultBean<List<UserMesBean>> result = sdsgService.getActivityMarketDetailed(paraDate);
	...
	public ResultBean<List<UserMesBean>> getActivityMarketDetailedToCode(String nowDate, String startCode, String num) {
		...
		result = sdsgService.getActivityMarketDetailedToCode(paraDate, startCodeInt, startCodeInt+numInt+1);
		return result;
	}
}
