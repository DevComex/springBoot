...
import cn.gyyx.action.service.wd10yearcoser.LotteryService;
import cn.gyyx.log.sdk.GYYXLoggerFactory;

@Controller
@RequestMapping(value = "/wd10yearcoser/lottery")
public class Wd10YearLotteryController {
	private static final Logger logger = GYYXLoggerFactory
			.getLogger(Wd10YearLotteryController.class);
	...
	public ResultBean<String> addAddress(HttpServletRequest request,
			AddressBean address) {
		return lotteryService.addAddress(request, address,
				actionCode);
	}
