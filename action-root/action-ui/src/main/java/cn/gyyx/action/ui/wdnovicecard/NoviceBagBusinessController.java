...
@Controller
@RequestMapping("/novicebusiness")
public class NoviceBagBusinessController {
	...
	private static final Logger logger = GYYXLoggerFactory.getLogger(NoviceBagBusinessController.class);
	
	@RequestMapping("/index")
	public String index() {
		return "wd2999/business/index";
	}
	
	@RequestMapping("/loginIndex")
	public String loginIndex() {
		return "wd2999/business/loginIndex";
	}

	@RequestMapping("/receiveGiftIndex")
	public String receiveGiftIndex(String userType,Model model) {
		model.addAttribute("userType", userType);
		return "wd2999/business/receiveGiftIndex";
	}
	
	@RequestMapping("/registIndex")
	public String registIndex() {
		return "wd2999/business/registIndex";
	}
	...
	public ResultBean<String> regist(String userType, String accountName,String password,
		...
		try {
			...
			request.setAttribute("registSource", WDNoviceCommonUtil.REGIST_SOURCE_M_BUSINESS);
