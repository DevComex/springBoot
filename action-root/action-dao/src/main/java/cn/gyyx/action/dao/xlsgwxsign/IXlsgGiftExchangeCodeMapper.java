 ...
 * 描        述：驯龙三国微信签到功能-礼包兑换码Mapper
 */
public interface IXlsgGiftExchangeCodeMapper {
	public XlsgGiftExchangeCode getGiftExchangeCodeOne(XlsgGiftExchangeCode giftExchangeCode);
