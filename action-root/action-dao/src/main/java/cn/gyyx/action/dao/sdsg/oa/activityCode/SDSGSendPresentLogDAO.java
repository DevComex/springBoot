...
public class SDSGSendPresentLogDAO implements ISDSGSendPresentLogMapper {
	private static final Logger LOG = GYYXLoggerFactory
			.getLogger(SDSGSendPresentLogDAO.class);
	/**
	 * 
	 * @Title: getSession
	...
	public Integer getActivationProduct(String startTime,String endTime) {
		...
		Integer result = -1;
		try{
			ISDSGSendPresentLogMapper iPresentLogMapper = session.getMapper(ISDSGSendPresentLogMapper.class);
