...
public interface IAddressMapper {
	 ...
	 * @return AddressBean
	 */
	public AddressBean selectAddress(@Param("userCode") int userCode,@Param("actionCode") int actionCode);
	public AddressBean selectAddressByUser(@Param("userAccount") String userAccount,@Param("actionCode") int actionCode);
