package cn.gyyx.action.bll.oa.sdsg.activityCode;
...
import cn.gyyx.action.dao.sdsg.oa.activityCode.SDSGSendPresentLogDAO;
import cn.gyyx.log.sdk.GYYXLoggerFactory;

public class SDSGOAActivityCode {
	private static final Logger LOG = GYYXLoggerFactory.getLogger(SDSGOAActivityCode.class);
	private SDSGSendPresentLogDAO presentLogDAO = new SDSGSendPresentLogDAO();
	/**
	 * 激活-产品
	 */
