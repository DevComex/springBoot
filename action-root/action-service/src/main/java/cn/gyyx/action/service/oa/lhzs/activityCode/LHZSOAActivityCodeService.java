package cn.gyyx.action.service.oa.lhzs.activityCode;
...
import cn.gyyx.action.bll.oa.lhzs.activityCode.LHZSOAActivityCode;

public class LHZSOAActivityCodeService {
	private LHZSOAActivityCode oaActivityCodeBLL = new LHZSOAActivityCode();
	...
	public ResultBean<String> insertActivationCode(int num,int channel,String channelStr) {
		InsertActivtionCodeBean para = new InsertActivtionCodeBean(num,channel,channelStr,"灵魂战神封测激活码2",0,16,"灵魂战神对接测试",278,"");
