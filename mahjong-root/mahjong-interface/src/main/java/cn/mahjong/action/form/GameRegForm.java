...
/**
  ...
  * @since 0.0.1
  */
@GroupSequence({ FirstGroup.class, SecondGroup.class, GameRegForm.class })
public class GameRegForm {
     ...
     * 用户注册时间
     */
    @Min(value = 1,message = "注册时间不能为空", groups = {FirstGroup.class})
    ...
    public String toString() {
        return "GameRegForm [userId=" + userId + ", createTime=" + createTime
                + ", ip=" + ip + "]";
    }
